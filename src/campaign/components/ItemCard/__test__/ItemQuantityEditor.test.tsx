...
describe("ItemQuantityEditor", () => {
  ...
  it("renders the quantity provided", () => {
    render(<ItemQuantityEditor item={createItem({ quantity: 20 })} />);
  ...
  describe("plus button", () => {
    it("adds 1 to quantity when clicking +", () => {
      render(<ItemQuantityEditor item={createItem({ quantity: 1 })} />);
  ...
  describe("deduct button", () => {
    it("deducts 1 from quantity when clicking -", () => {
      render(<ItemQuantityEditor item={createItem({ quantity: 2 })} />);
    ...
    it("deducts 10 from quantity when shift clicking -", () => {
      render(<ItemQuantityEditor item={createItem({ quantity: 11 })} />);
    ...
    it("deducts 100 from quantity when alt clicking -", () => {
      render(<ItemQuantityEditor item={createItem({ quantity: 101 })} />);
    ...
    it("disables - button when value is 0", () => {
      render(<ItemQuantityEditor item={createItem({ quantity: 0 })} />);
    ...
    it("cannot deduct below 0 when shift clicking -", () => {
      render(<ItemQuantityEditor item={createItem({ quantity: 5 })} />);
